...
export default function Overview({ theme = 'dark' }) {
  ...
  useGSAP(() => {
    if (!loading) {
      ...
      tl.from('.ov-heading-container', { y: 30, opacity: 0, duration: 0.8, ease: 'expo.out' })
        .from('.stat-card', { y: 20, opacity: 0, duration: 0.7, stagger: 0.1, ease: 'expo.out' }, "-=0.5")
        .from('.main-grid-item', { y: 20, opacity: 0, duration: 0.7, stagger: 0.15, ease: 'expo.out' }, "-=0.4");
    }
  ...
  return (
    <div>
      <div className={`ov-root ${isDark ? 'dark' : 'light'}`} ref={container} style={{
        '--text': text,
        '--subtext': subtext,
        '--cardBg': cardBg,
        ...
        <div className="ov-heading-container">
          ...
          <p className="ov-date-str">
            {dateStr} · <span className="ov-hotel-name">{hotel.name || 'Innhance Hotels'}</span>
          </p>
        </div>
        ...
        {showTutorial && (
          <div className={`tutorial-banner ${isDark ? 'dark' : 'light'}`}>
            <div className="tutorial-banner-top">
              ...
              <button className="tutorial-dismiss-btn" onClick={dismissTutorial}>Got it ✓</button>
            </div>
            <div className="tutorial-items">
              <div className="tutorial-item">
                ...
                <div>
                  ...
                  <div className="tutorial-item-desc">Your daily actions, smart alerts & recent bookings at a glance.</div>
                </div>
              </div>
              <div className="tutorial-item">
                <span className="tutorial-item-icon">📅</span>
                <div>
                  ...
                  <div className="tutorial-item-desc">Add, view, filter and manage all guest reservations.</div>
                </div>
              </div>
              <div className="tutorial-item">
                ...
                <div>
                  ...
                  <div className="tutorial-item-desc">Manage room types, pricing, availability and inventory.</div>
                </div>
              </div>
              <div className="tutorial-item">
                <span className="tutorial-item-icon">💬</span>
                <div>
                  ...
                  <div className="tutorial-item-desc">Talk to guests, respond to inquiries and handle requests.</div>
                </div>
              </div>
              <div className="tutorial-item">
                <span className="tutorial-item-icon">📈</span>
                <div>
                  ...
                  <div className="tutorial-item-desc">Track revenue, occupancy trends and your top guests.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="stats-grid-container">
          {stats.map((stat, i) => (
            <div key={i} className={`stat-card ${isDark ? 'dark' : 'light'}`}
              ...
              <div className="stat-card-footer">
                <div>
                  <span className={`stat-trend ${stat.trend === 'up' ? 'up' : 'down'}`}>
        ...
        {/* Main grid */}
        <div className="main-grid" style={{ gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>
            ...
            <div className="simple-list">
              <div className="list-item">
                ...
                <div className="list-item-content">
                  ...
                  <div className="list-item-desc">High demand detected for this weekend</div>
                </div>
              </div>
              <div className="list-item">
                <span className="list-item-icon">📞</span>
                <div className="list-item-content">
                  <div className="list-item-title">Follow up with hot leads</div>
                  <div className="list-item-desc">3 inquiries pending response</div>
                </div>
              </div>
              <div className="list-item">
                ...
                <div className="list-item-content">
                  ...
                  <div className="list-item-desc">Only 2 standard rooms left</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`main-grid-item ${isDark ? 'dark' : 'light'}`}>
            ...
            <div className="simple-list">
              <div className="list-item">
                <span className="list-item-icon">😴</span>
                <div className="list-item-content">
                  <div className="list-item-title">High intent lead inactive</div>
                  <div className="list-item-desc">Guest looking at Deluxe Suite left chat</div>
                </div>
              </div>
              <div className="list-item">
                <span className="list-item-icon">💳</span>
                <div className="list-item-content">
                  ...
                  <div className="list-item-desc">Booking #BK00102 waiting for payment</div>
                </div>
              </div>
              <div className="list-item">
                <span className="list-item-icon">📉</span>
                <div className="list-item-content">
                  ...
                  <div className="list-item-desc">3 guests dropped off after seeing suite price</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`main-grid-item ${isDark ? 'dark' : 'light'}`}>
            <div className="grid-item-header">
              ...
              <button onClick={() => navigate('/bookings')} className="view-all-btn">View all →</button>
            </div>
            <div className="simple-list">
              {formattedBookings.slice(0, 3).map(b => (
                <div key={b.id} className="list-item booking-simple">
                  ...
                  <div className={`booking-simple-amount ${isDark ? 'dark' : 'light'}`}>{b.amount}</div>
                </div>
              ))}
            </div>
          </div>
